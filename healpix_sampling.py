...
def arguments_parser():
    ...
    parser.add_argument("--output_path",default="processed_images/",help="Path of the processed numpy image folder")
...
def samplingImage(image_path,output_path,x,y):
...
def main():
    ...
    x=x.astype(int)
    y=y.astype(int)
    samplingImage(image_path,output_path,x,y)
